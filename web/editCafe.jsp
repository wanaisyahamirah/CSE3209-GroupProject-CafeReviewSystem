<%-- 
    Document   : editCafe
    Created on : Jun 19, 2021, 2:15:24 AM
    ...
    <body>
        ...
        <div class="bg-gray-500 min-h-screen flex flex-col rounded">
            <div class="flex text-white bg-gray-900 p-12 justify-center">
                ...
                <span class="pl-2 font-semibold text-xl tracking-tight">Edit Cafe</span>
            </div>
            <div class="">
                <div class="p-10">
                    <!--Card 1-->
                        ...
                        <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-3xl p-4 flex justify-between leading-normal">
                            ...
                            <div class="mb-8">
                                ...
                                <p class="text-sm text-gray-600 flex items-center">
                                    <%=cafe.getCafeLocation()%>Members only
                                </p>
                                <br>
            ...
            <div class="sm:flex sm:space-x-2 justify-center my-auto rounded-3xl w-full flex flex-col items-center justify-center px-60">
                <div class="bg-gray-100 px-6 py-8 rounded-t-3xl shadow-md text-black w-full">
                    <form class="mt-8 space-y-6" name="FormEditUser" action="CafeController" method="POST" enctype="multipart/form-data">
                        <div class="rounded-md shadow-sm -space-y-px">
                            ...
                            <br>
                            <div>
                                <input type="file" name="cafeImage">
                            </div>
                            <br>
                            <div>
                                <label class="sr-only">Cafe Name</label>
                                <input type="text" name="cafeName" value="<%=cafe.getCafeName()%>" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                            </div>
                            <br>
                            <div>
                                <label class="sr-only">Cafe Location</label>
                                <input type="text" name="cafeLocation" value="<%=cafe.getCafeLocation()%>" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                            </div>
                            <br>
                            <div>
                                <label class="sr-only">Cafe Description</label>
                                <input type="text" name="cafeDescription" value="<%=cafe.getCafeDescription()%>" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm">
                            </div>
                            <div>
