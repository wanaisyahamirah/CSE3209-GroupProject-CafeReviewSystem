<%-- 
    Document   : listReview
    Created on : Jun 24, 2021, 12:40:47 AM
    ...
    <body>
        <div class="flex items-center justify-between flex-wrap bg-teal p-6">
            ...
            <div>
                <div class="flex items-center">
                    ...
                    <div>
                        <a href="editProfile.jsp?id=<%=userid%>" class="hover:text-gray-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="bg-gray-500 min-h-screen flex flex-col rounded">
            <div class="flex text-white bg-gray-900 p-12 items-center justify-center">
                ...
                <span class="pl-2 font-semibold text-xl tracking-tight">My Review List</span>
            </div>
            <div class="">
                    ...
                    <div class="max-w-7xl mx-auto">
                        <div class="border-r border-b border-l border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-white rounded-3xl p-4 flex justify-between leading-normal">
                            ...
                            <div class="mb-8 w-full">
                                ...
                                <p class="text-center text-sm text-gray-600 flex">
                            ...
                            <div class="flex flex-col items-center">
                                <div class="flex text-sm">
                                    <a href="editReview.jsp?rid=<%=review.getRid()%>">
                                    ...
                                    <form action="<%=request.getContextPath()%>/ReviewController">
                                        <button type="submit" name="action" value="delete">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                            </svg>
                                        </button>
                                        <input name="rid" type="hidden" value="<%=review.getRid()%>">
                                    </form>
                                </div>
                            </div>
                        </div>
